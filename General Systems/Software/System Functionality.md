...
2. **Autonomous Navigation**: Uses Nav2's `NavigateToPose` action to navigate to frontiers.
3. **Frontier Detection**: Identifies free cells adjacent to unknown areas as frontiers.
4. **Navigation**: Sends goals to Nav2's `NavigateToPose` action server for autonomous navigation to the closest frontier.
5. **Dynamic Goal Selection**: Continuously updates and selects frontiers during exploration.
6. **Backtracking**: Backtracks after reaching dead-end in a maze.

**Overall system Flowchart**: [https://drive.google.com/file/d/1UNRVbAaPh1y145qAUgpA2_ejncv4pG1s/view?usp=sharing]
...
**Flowchart**: [https://drive.google.com/file/d/1Juc05ze4xoAqjQbti7Lpri1xNHxvHQ0_/view?usp=sharing]
...
**Flowchart**: [https://drive.google.com/file/d/1J0MUkJVa5hJuIplLjcbsz1neXsU1B1Ch/view?usp=sharing]
